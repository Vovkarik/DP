...
namespace Frontend.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string id = "";
            StringContent stringContent = new StringContent("value=" + data + ":" + region ,Encoding.UTF8, "application/x-www-form-urlencoded");
            ...
            return Redirect($"/Home/TextDetails/{id + ":" +region}");
        }
